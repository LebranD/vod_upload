          ...
          children: [
            InkWell(
              ...
              onTap: () async {
                ...
                if (image == null || StringUtils.isEmpty(image.path) || StringUtils.isEmpty(image.name)) {
...
abstract class _IFileItemState extends State<FileItem> implements ITXVideoPublishListener, ITXMediaPublishListener {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            StringUtils.isNotEmpty(widget.filePath) ? widget.filePath.toString() : "",
          ...
          Row(
            ...
            children: [
              InkWell(
                ...
                onTap: () async {
                  if (StringUtils.isEmpty(widget.filePath) || StringUtils.isEmpty(widget.fileName)) {
                    EasyLoading.showError(AppLocals.of(context).noFileSelected);
                    return;
                  }
